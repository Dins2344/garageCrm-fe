...
import { getAllGarages } from '../../services/apiServices/adminService';
        ...
        <tbody className="divide-y divide-gray-50">
          {garages.map((garage) => (
            <tr key={garage._id} className="hover:bg-gray-50/50 transition-colors">
              ...
              <td className="px-6 py-5">
                <div className="font-semibold text-gray-800 text-sm">{garage.owner?.name || 'N/A'}</div>
                <div className="text-xs text-gray-400">{garage.owner?.email || '-'}</div>
              </td>
              <td className="px-6 py-5">
