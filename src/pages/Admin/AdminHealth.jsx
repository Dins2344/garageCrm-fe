...
import { getSystemHealth } from '../../services/apiServices/adminService';
...
function HealthItem({ label, value, sub }) {
  return (
    <div>
...
export default function AdminHealth() {
  ...
  if (loading) return <div>Diagnostic in progress...</div>;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <HealthSection title="CPU & Load">
          <HealthItem label="CPU Model" value={health.cpu.model} sub={`${health.cpu.cores} Cores`} />
