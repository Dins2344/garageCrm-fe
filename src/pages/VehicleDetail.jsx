      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {vehicle.customer && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <InfoBlock icon={HiOutlineUser} label="Name" value={vehicle.customer.name} />
              <InfoBlock icon={HiOutlinePhone} label="Phone" value={vehicle.customer.phone} />
              <InfoBlock icon={HiOutlineMail} label="Email" value={vehicle.customer.email} />
              <InfoBlock
                icon={HiOutlineLocationMarker}
                label="City"
                value={vehicle.customer.address?.city || vehicle.customer.city}
              />
            </div>
          </div>
        )}
            ...
            {jobCards.map((jc, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Status */}
                  <div className="col-span-2">
                    <Badge intent={STATUS_INTENT[jc.status] || 'none'}>
